...
class User(Base):
    ...
    def update_profile(self, first_name: str, last_name: str, bio: str, profile_picture_url: str):
        """Updates the user's profile information."""
        self.first_name = first_name
        self.last_name = last_name
        self.bio = bio
        self.profile_picture_url = profile_picture_url
        self.updated_at = func.now()  # Set updated timestamp
'''
...
class User(Base):
    ...
    verification_token_expires_at: Mapped[datetime] = Column(DateTime(timezone=True), nullable=True)
    email_verified: Mapped[bool] = Column(Boolean, default=False, nullable=False)
    hashed_password: Mapped[str] = Column(String(255), nullable=False)
